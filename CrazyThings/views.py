...
def children(request, data=None):
    ...
    if data == None:
        ...
        children = Product.objects.filter(category='cd').filter(brand=data)
    elif data == 'nine':
        children = Product.objects.filter(category='cd').filter(brand=data)
    elif data == 'six':
        children = Product.objects.filter(category='cd').filter(brand=data)
...
def comic(request, data=None):
    ...
    if data == None:
        ...
        comic = Product.objects.filter(category='cm').filter(brand=data)
    elif data == 'dc':
        comic = Product.objects.filter(category='cm').filter(brand=data)
    elif data == 'indian':
        comic = Product.objects.filter(category='cm').filter(brand=data)
        ...
        comic = Product.objects.filter(category='cm').filter(discounted_price__lt=1000)
    elif data == 'above':
        comic = Product.objects.filter(category='cm').filter(discounted_price__gt=1000)
    if request.user.is_authenticated:
        totalitem = len(Cart.objects.filter(user=request.user))
...
def exam(request, data=None):
    ...
    if data == None:
        ...
        exam = Product.objects.filter(category='ex').filter(brand=data)
    elif data == 'neet':
        exam = Product.objects.filter(category='ex').filter(brand=data)
    elif data == 'upsc':
        exam = Product.objects.filter(category='ex').filter(brand=data)
...
def school(request, data=None):
    ...
    if data == None:
        ...
        school = Product.objects.filter(category='sc').filter(brand=data)
    elif data == 'tenth':
        school = Product.objects.filter(category='sc').filter(brand=data)
    elif data == 'seven':
        school = Product.objects.filter(category='sc').filter(brand=data)
        ...
        school = Product.objects.filter(category='sc').filter(discounted_price__lt=250)
    elif data == 'above':
        school = Product.objects.filter(category='sc').filter(discounted_price__gt=250)
    if request.user.is_authenticated:
        totalitem = len(Cart.objects.filter(user=request.user))
...
def university(request, data=None):
    ...
    if data == None:
        ...
        university = Product.objects.filter(category='un').filter(brand=data)
    elif data == 'eng':
        university = Product.objects.filter(category='un').filter(brand=data)
    elif data == 'manage':
        university = Product.objects.filter(category='un').filter(brand=data)
...
def air(request, data=None):
    ...
    if data == None:
        ...
        air = Product.objects.filter(category='ac').filter(discounted_price__lt=40000)
    elif data == 'above':
        air = Product.objects.filter(category='ac').filter(discounted_price__gt=40000)
    if request.user.is_authenticated:
        totalitem = len(Cart.objects.filter(user=request.user))
...
def refrigerator(request, data=None):
    ...
    if data == None:
        ...
        refrigerator = Product.objects.filter(category='r').filter(brand=data)
    elif data == 'double':
        refrigerator = Product.objects.filter(category='r').filter(brand=data)
    elif data == 'triple':
        refrigerator = Product.objects.filter(category='r').filter(brand=data)
        ...
        refrigerator = Product.objects.filter(category='r').filter(discounted_price__lt=75000)
    elif data == 'above':
        refrigerator = Product.objects.filter(category='r').filter(discounted_price__gt=75000)
    if request.user.is_authenticated:
        totalitem = len(Cart.objects.filter(user=request.user))
...
def washing(request, data=None):
    ...
    if data == None:
        ...
        washing = Product.objects.filter(category='w').filter(brand=data)
    elif data == 'top':
        washing = Product.objects.filter(category='w').filter(brand=data)
    elif data == 'semi':
        washing = Product.objects.filter(category='w').filter(brand=data)
    elif data == 'below':
        washing = Product.objects.filter(category='w').filter(discounted_price__lt=25000)
    elif data == 'above':
        washing = Product.objects.filter(category='w').filter(discounted_price__gt=25000)
    if request.user.is_authenticated:
        totalitem = len(Cart.objects.filter(user=request.user))
...
def cooler(request, data=None):
    ...
    if data == None:
        ...
        cooler = Product.objects.filter(category='cl').filter(brand=data)
    elif data == 'personal':
        cooler = Product.objects.filter(category='cl').filter(brand=data)
    elif data == 'tower':
        cooler = Product.objects.filter(category='cl').filter(brand=data)
        ...
        cooler = Product.objects.filter(category='cl').filter(discounted_price__lt=10000)
    elif data == 'above':
        cooler = Product.objects.filter(category='cl').filter(discounted_price__gt=10000)
    if request.user.is_authenticated:
        totalitem = len(Cart.objects.filter(user=request.user))
...
def fan(request, data=None):
    ...
    if data == None:
        ...
        fan = Product.objects.filter(category='f').filter(brand=data)
    elif data == 'table':
        fan = Product.objects.filter(category='f').filter(brand=data)
    elif data == 'pedestal':
        fan = Product.objects.filter(category='f').filter(brand=data)
        ...
        fan = Product.objects.filter(category='f').filter(discounted_price__lt=2500)
    elif data == 'above':
        fan = Product.objects.filter(category='f').filter(discounted_price__gt=2500)
    if request.user.is_authenticated:
        totalitem = len(Cart.objects.filter(user=request.user))
...
def fruitvegetable(request, data=None):
    ...
    if data == None:
        ...
        fruitvegetable = Product.objects.filter(category='fv').filter(brand=data)
    elif data == 'Exotic':
        fruitvegetable = Product.objects.filter(category='fv').filter(brand=data)
    elif data == 'Fruits':
        fruitvegetable = Product.objects.filter(category='fv').filter(brand=data)
        ...
        fruitvegetable = Product.objects.filter(category='fv').filter(discounted_price__lt=250)
    elif data == 'above':
        fruitvegetable = Product.objects.filter(category='fv').filter(discounted_price__gt=250)
    if request.user.is_authenticated:
        totalitem = len(Cart.objects.filter(user=request.user))
...
def beverages(request, data=None):
    ...
    if data == None:
        ...
        beverages = Product.objects.filter(category='be').filter(brand=data)
    elif data == 'water':
        beverages = Product.objects.filter(category='be').filter(brand=data)
    elif data == 'fruit':
        beverages = Product.objects.filter(category='be').filter(brand=data)
...
def foodgrains(request, data=None):
    ...
    if data == None:
        ...
        foodgrains = Product.objects.filter(category='fg').filter(brand=data)
    elif data == 'dal':
        foodgrains = Product.objects.filter(category='fg').filter(brand=data)
    elif data == 'atta':
        foodgrains = Product.objects.filter(category='fg').filter(brand=data)
...
def cookies(request, data=None):
    ...
    if data == None:
        ...
        cookies = Product.objects.filter(category='co').filter(brand=data)
    elif data == 'cokie':
        cookies = Product.objects.filter(category='co').filter(brand=data)
    elif data == 'cream':
        cookies = Product.objects.filter(category='co').filter(brand=data)
        ...
        cookies = Product.objects.filter(category='co').filter(discounted_price__lt=100)
    elif data == 'above':
        cookies = Product.objects.filter(category='co').filter(discounted_price__gt=100)
    if request.user.is_authenticated:
        totalitem = len(Cart.objects.filter(user=request.user))
...
def noodles(request, data=None):
    ...
    if data == None:
        ...
        noodles = Product.objects.filter(category='no').filter(brand=data)
    elif data == 'hakka':
        noodles = Product.objects.filter(category='no').filter(brand=data)
    elif data == 'instant':
        noodles = Product.objects.filter(category='no').filter(brand=data)
        ...
        noodles = Product.objects.filter(category='no').filter(discounted_price__lt=100)
    elif data == 'above':
        noodles = Product.objects.filter(category='no').filter(discounted_price__gt=100)
    if request.user.is_authenticated:
        totalitem = len(Cart.objects.filter(user=request.user))
...
def oil(request, data=None):
    ...
    if data == None:
        ...
        oil = Product.objects.filter(category='ol').filter(brand=data)
    elif data == 'spice':
        oil = Product.objects.filter(category='ol').filter(brand=data)
    elif data == 'masala':
        oil = Product.objects.filter(category='ol').filter(brand=data)
        ...
        oil = Product.objects.filter(category='ol').filter(discounted_price__lt=200)
    elif data == 'above':
        oil = Product.objects.filter(category='ol').filter(discounted_price__gt=200)
    if request.user.is_authenticated:
        totalitem = len(Cart.objects.filter(user=request.user))
...
def snacks(request, data=None):
    ...
    if data == None:
        ...
        snacks = Product.objects.filter(category='sn').filter(brand=data)
    elif data == 'namkeen':
        snacks = Product.objects.filter(category='sn').filter(brand=data)
    elif data == 'frozen':
        snacks = Product.objects.filter(category='sn').filter(brand=data)
    elif data == 'below':
        snacks = Product.objects.filter(category='sn').filter(discounted_price__lt=150)
    elif data == 'above':
        snacks = Product.objects.filter(category='sn').filter(discounted_price__gt=150)
    if request.user.is_authenticated:
        totalitem = len(Cart.objects.filter(user=request.user))
...
def deo(request, data=None):
    ...
    if data == None:
        ...
        deo = Product.objects.filter(category='de').filter(brand=data)
    elif data == 'women':
        deo = Product.objects.filter(category='de').filter(brand=data)
    elif data == 'men':
        deo = Product.objects.filter(category='de').filter(brand=data)
        ...
        deo = Product.objects.filter(category='de').filter(discounted_price__lt=1000)
    elif data == 'above':
        deo = Product.objects.filter(category='de').filter(discounted_price__gt=1000)
    if request.user.is_authenticated:
        totalitem = len(Cart.objects.filter(user=request.user))
